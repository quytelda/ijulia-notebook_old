...
#  Default: '/jupyter/.jupyter/lab/user-settings'
# c.LabApp.user_settings_dir = '/jupyter/.jupyter/lab/user-settings'
...
#  Default: '/jupyter/.jupyter/lab/workspaces'
# c.LabApp.workspaces_dir = '/jupyter/.jupyter/lab/workspaces'
